...
2. Fill in the repository details:
   ...
   - **Description**: `Unified Docker deployment for Frappe CRM, LMS, HRMS, Drive, Insights, Gameplan, and Helpdesk - Easy single-site setup`
...
```bash
gh repo create frappe-unified-deployment --public --description="Unified Docker deployment for Frappe CRM, LMS, HRMS, Drive, Insights, Gameplan, and Helpdesk - Easy single-site setup"
```
